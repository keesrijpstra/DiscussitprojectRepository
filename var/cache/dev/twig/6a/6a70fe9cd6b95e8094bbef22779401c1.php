...
class __TwigTemplate_f8b37c9196f3b2a9b0e7d9940edf418a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "post/comment.html.twig", 1);
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 10
        echo "    ";
        echo twig_include($this->env, $context, "post/_post.html.twig", ["post" => (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 10, $this->source); })())]);
        echo "
    ...
    <div class=\"mt-4\">
        ...
        ";
        // line 19
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 19, $this->source); })()), "text", [], "any", false, false, false, 19), 'widget', ["attr" => ["class" => "block w-full shadow-sm border-gray-300"]]);
        echo "
        ";
        // line 20
    ...
    <div>
        <button type=\"submit\" class=\"bock w-full shadow-sm border-transparent bg-indigo-600 hover:bg-indigo-400 rounded-md border p-2 mt-4 mb-2\">Save</button>
    </div>
...
{% block bread %}
    -> <a href=\"{{ path('app_show_one', {post: post.id}) }}\">Post -> Comment</a>
{% endblock %}
...
{% endblock %}", "post/comment.html.twig", "/home/kees/PhpstormProjects/chrisvbeem/templates/post/comment.html.twig");
    }
}
