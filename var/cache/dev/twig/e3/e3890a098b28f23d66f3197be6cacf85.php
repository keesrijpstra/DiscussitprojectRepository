...
class __TwigTemplate_3f6b185ac0ba1cd8df2f9778c220dde4 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 13
        echo twig_include($this->env, $context, "post/_post_list.html.twig", ["posts" => (isset($context["posts"]) || array_key_exists("posts", $context) ? $context["posts"] : (function () { throw new RuntimeError('Variable "posts" does not exist.', 13, $this->source); })())]);
        echo "
";
...
{% block body %}
    ...
    {{ include ('post/_post_list.html.twig', { posts: posts }) }}
{% endblock %}", "profile/index.html.twig", "/home/kees/PhpstormProjects/chrisvbeem/templates/profile/index.html.twig");
    }
}
