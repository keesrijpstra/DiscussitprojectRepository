...
/* post/edit.html.twig */
class __TwigTemplate_3802d5665795fb6583cb24c0c7f03b80 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("{% block title %} Editing existing post {% endblock %}
{% block bread %}
    -> <a href=\"{{ path('app_show_one', {post: post.id}) }}\">Post -></a> Edit
{% endblock %}
{% block body %}
    {{ include('post/_form.html.twig') }}
{% endblock %}
", "post/edit.html.twig", "/home/kees/PhpstormProjects/chrisvbeem/templates/post/edit.html.twig");
    }
}
